  ...
  window.addEventListener('bmg:paymentConfirmed', function (e) {
    ...
    (async function () {
      ...
      try {
        ...
        /* NOTE: slot currentMembers increment is intentionally NOT done here.
           sportobook_combined_patches.js (PART3/finalisePoolBooking) is the
           single authoritative place that increments currentMembers.
           Doing it here too caused the slot to show +2 members per booking. */
